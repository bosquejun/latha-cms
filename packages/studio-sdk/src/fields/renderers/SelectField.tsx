          ...
          {options.map((o) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'inline-flex h-control-sm flex-1 items-center justify-center gap-tight rounded-sm px-group text-sm font-medium transition-all outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50',
                  active
