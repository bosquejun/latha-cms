        ...
        {advancedChildren.length > 0 && (
          <>
            ...
            <button
              ...
              className="flex min-h-tap w-full items-center justify-between px-card py-2.5 text-caption font-medium text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground md:min-h-0"
            >
              Advanced options
              <ChevronDown
